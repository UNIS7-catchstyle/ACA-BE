...
public class Post {
    ...
    public Post(Long userId, String celebName, String groupName, ScheduleType scheduleType, LocalDate postDate, String outfitImageUrl, String linkUrl, LinkType linkType) {
        this.userId = userId;
